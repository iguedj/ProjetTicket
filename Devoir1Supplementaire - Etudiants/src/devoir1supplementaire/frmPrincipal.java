...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnNbAnneesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNbAnneesMouseClicked
        ...
        while (totalT <= lecoutTotal)
        {
            totalT = totalT + anneeA;
            anneeA = anneeA * r;
            
            annee++;
        }
        lblNbSemaines.setText(annee + " années");   
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        //exercice 3
         ...
         { 
             ...
             primedebeug=Integer.parseInt(txtNbBugs.getText())*0.04;
                    if(primedebeug > 400)
                    {
                        primedebeug = 400;
                    }
                    ...
                    {
                        int i=0;
                        nouvelleannee=(Integer.parseInt(txtNbAnnees.getText())-4);
                        while (i <nouvelleannee)
                        {
                            nombreannee=nombreannee+30;
                        } 
                    }
                    double total=primedebeug+nombreannee;
